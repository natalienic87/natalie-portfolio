    ...
    <footer style={{ position: 'relative', backgroundColor: '#101010', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '80px 40px 60px' }}>
        ...
        <h2 className="font-heading"
          style={{ fontWeight: 500, fontSize: '72px', color: '#FEFEFE', margin: '0 0 20px', lineHeight: 1.05 }}>
        ...
        <p className="font-body"
          ...
          Currently accepting <strong style={{ color: '#FEFEFE', fontStyle: 'italic' }}>Generative AI</strong>,
          {' '}concept <strong style={{ color: '#FEFEFE' }}>Branding</strong>, and cinematic{' '}
          <strong style={{ color: '#FEFEFE' }}>Video</strong> into singular immersive experiences.
        </p>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginBottom: '48px' }}>
          <a href="#" className="font-body"
            style={{
              ...
              backgroundColor: '#F97316', color: '#FEFEFE',
              fontWeight: 700, fontSize: '11px', letterSpacing: '0.18em', textTransform: 'uppercase',
          ...
          <a href="#" className="font-body"
            style={{
              display: 'inline-block',
              backgroundColor: 'transparent', color: '#FEFEFE',
              fontWeight: 700, fontSize: '11px', letterSpacing: '0.18em', textTransform: 'uppercase',
              textDecoration: 'none', padding: '14px 28px',
              border: '1.5px dashed rgba(255,255,255,0.6)', borderRadius: '6px',
            }}>
            Contact Me
          </a>
        </div>
      ...
      <img src="/images/7-footer/Planet 1.png" alt=""
      ...
      <img src="/images/7-footer/L Purple Flower 1.png" alt=""
      ...
      <img src="/images/7-footer/Moon_ 1.png" alt=""
      ...
      <img src="/images/7-footer/Yellow Diamond Star 2.png" alt=""
      ...
      <img src="/images/7-footer/White Star 1.png" alt=""
      ...
      <div style={{ position: 'relative', lineHeight: 0 }}>
        ...
        <img src="/images/7-footer/Yellow Flower 1 (1).png" alt=""
        ...
        <img src="/images/7-footer/M Purple Flower 1.png" alt=""
          className="animate-spin-planet-reverse"
        ...
        <img src="/images/7-footer/Yellow Flower 2.png" alt=""
        ...
        <img src="/images/7-footer/White fern 1 (1).png" alt=""
